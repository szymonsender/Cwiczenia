...
class BackRGymPage extends StatefulWidget {
  const BackRGymPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<BackRGymPage> createState() => _BackRGymPageState();
}

class _BackRGymPageState extends State<BackRGymPage> {
  var currentIndex = 0;
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage('assets/images/back17.gif'),
              ),
            ),
            height: 250,
            padding: const EdgeInsets.all(25),
          ...
          Container(
            decoration: BoxDecoration(
              ...
              color: Colors.white,
              image: const DecorationImage(
                image: AssetImage('assets/images/back17a.gif'),
              ),
            ),
            height: 250,
            padding: const EdgeInsets.all(25),
          ...
          Container(
            decoration: BoxDecoration(
              ...
              color: Colors.white,
              image: const DecorationImage(
                image: AssetImage('assets/images/back17b.gif'),
              ),
            ),
            height: 250,
            padding: const EdgeInsets.all(25),

...
class ChestFGymPage extends StatefulWidget {
  const ChestFGymPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<ChestFGymPage> createState() => _ChestFGymPageState();
}

class _ChestFGymPageState extends State<ChestFGymPage> {
  var currentIndex = 0;
          ...
          Container(
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage('assets/images/chest6.gif'),
              ),
            ),
            height: 250,
            padding: const EdgeInsets.all(25),

      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            margin: const EdgeInsets.all(10),
            child: const Text(
              'W celu zwiększenia stopnia trudności ćwiczenie to można wykonywać na jednej nodze(rys.4c). Oddech bierzemy przed rozpoczęciem przysiady-powietrze wypuszczamy, gdy podnosimy się z przysiadu.',
              style: TextStyle(fontSize: 15),
            ),
          ),
          Container(
